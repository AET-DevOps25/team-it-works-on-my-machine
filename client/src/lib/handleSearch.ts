...
export function handleSearch(repoUrl: string, setRepoUrl: React.Dispatch<React.SetStateAction<string>>, setAnalyses: React.Dispatch<React.SetStateAction<Analysis[]>>) {
    if (!repoUrl) {
